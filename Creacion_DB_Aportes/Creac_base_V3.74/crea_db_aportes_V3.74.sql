...
-- ---------------------------------------------------------------------
-- COMMENT "View que une t_users1 y t_users2" 
-- ---------------------------------------------------------------------  
...
-- Direccion 1
  osc_calle_1 	VARCHAR (64) NOT NULL DEFAULT "N/D",
  osc_num_1 	VARCHAR (6)	 NOT NULL DEFAULT "N/D",
  osc_ciudad_1 	VARCHAR (32) NOT NULL DEFAULT "N/D",
  osc_cp_1		VARCHAR (8)  NOT NULL DEFAULT "N/D",
  osc_prov_1 	VARCHAR (12) NOT NULL DEFAULT "N/D",
-- Direccion 2
  osc_calle_2 	VARCHAR (64) NOT NULL DEFAULT "N/D",
  osc_num_2 	VARCHAR (6)  NOT NULL DEFAULT "N/D",
  osc_ciudad_2 	VARCHAR (32) NOT NULL DEFAULT "N/D",
  osc_cp_2		VARCHAR (8)  NOT NULL DEFAULT "N/D",
  osc_prov_2 	VARCHAR (12) NOT NULL DEFAULT "N/D",
--
  osc_pag_web 	VARCHAR (128)  NOT NULL DEFAULT "N/D",
--
...
--  -------------------------------------------------------------------
--  -------------------------------------------------------------------
-- View que une las tablas de t_proyectos con t_hist_user_proy
--  -------------------------------------------------------------------
--  -------------------------------------------------------------------
